...
public class Heap<E> extends AbstractQueue<E> {
	...
	/**
	 * Remove a specified item from the priority queue. If it appears more than
	 * once, only one is removed.
	 * 
	 * @param o
	...
	public boolean remove(Object o) {
		...
		while (leftChild < theData.size() && compare(index, leftChild) > 0
				|| rightChild < theData.size()
				&& compare(index, rightChild) > 0) {
