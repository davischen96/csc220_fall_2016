...
public class MaintainQueue {
		...
		while (true) {
			...
			try {
				...
				case 0:
					...
					break;
				case 1:
					ui.sendMessage("Customer " + customers.element() + " is next in the queue");
					break;
				case 2:
					ui.sendMessage("Customer " + customers.remove() + " removed from the queue");
					break;
				case 3:
				...
				case 4:
					...
					if (foundAhead == -1)
						...
						ui.sendMessage("The number of customers ahead of " + name + " is " + foundAhead);
					break;
				case 5:
					ui.sendMessage(
	...
	/**
	 * Create a string representation of the queue contents with each entry on
	 * its own line
	 * 
